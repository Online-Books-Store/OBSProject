<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{isset(Auth::user()->image) ? asset("uploads/".Auth::user()->image) : 'http://lorempixel.com/200/200/people/9/'}} " class="avatar img-circle" style="width:40px; height:40px;" alt="User Image">
        </div>
